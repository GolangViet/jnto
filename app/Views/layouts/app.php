...
<?php if ($success = app()->session()->pullFlash('success')): ?><div class="alert"><?= e($success) ?></div><?php endif; ?>
<?php if ($error = app()->session()->pullFlash('error')): ?><div class="alert error"><?= e($error) ?></div><?php endif; ?>
<?= $content ?>
</main>
</body>
</html>
